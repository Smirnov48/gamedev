...
//	Texture fractions;
	...
	private void loadTexture(){
		...
		for(int i=0;i<3;i++) Fractions.put("castle"+i, tmpCastle[0][i]);
		...
		for(int i=0;i<3;i++) Points.put("point"+i, tmpPoints[0][i]);
	}
...
//		batch.draw(hpLogo,20,570,48,48);
		batch.draw(Points.get("point1"), 10, Gdx.graphics.getHeight()-Points.get("point1").getRegionHeight()+Points.get("point1").getRegionHeight()/5);
		batch.draw(Points.get("point0"), 10, Gdx.graphics.getHeight()-Points.get("point0").getRegionHeight()*2+Points.get("point0").getRegionHeight()/5);
		batch.draw(Points.get("point2"), 10, Gdx.graphics.getHeight()-Points.get("point2").getRegionHeight()*3+Points.get("point2").getRegionHeight()/5);
		font.draw(batch, String.valueOf((int)(player.getDP()*100)),75,Gdx.graphics.getHeight()-Points.get("point1").getRegionHeight()+Points.get("point1").getRegionHeight()/1.25f);
		font.draw(batch, String.valueOf((int)(player.getFP()*100)),75,Gdx.graphics.getHeight()-Points.get("point0").getRegionHeight()*2+Points.get("point0").getRegionHeight()/1.25f);
		font.draw(batch, String.valueOf((int)(player.getHP()*100)),75,Gdx.graphics.getHeight()-Points.get("point2").getRegionHeight()*3+Points.get("point2").getRegionHeight()/1.25f);
...
//		batch.draw(fractions, 698,-15);
		...
		batch.draw(Fractions.get("castle1"), Gdx.graphics.getWidth()-Fractions.get("castle1").getRegionWidth()*2+2, 0);
		batch.draw(Fractions.get("castle0"), Gdx.graphics.getWidth()-Fractions.get("castle0").getRegionWidth()*3+4, 0);
		batch.end();
		}

...
public class Player {
	...
	public static boolean pressed() {
		if (InputOne.pressedKey() | InputTwo.pressedKey())
			return true;
		else
			return false;
	}
	...
	public static boolean getDebug() {
		if (InputOne.debug() | InputTwo.debug())
			return !debug;
		else
			return debug;
	}
	...
	public static boolean left() {
		if (InputOne.key() == 29 | InputOne.key() == 21 | InputTwo.key() == 29 | InputTwo.key() == 21) {
			RTL = true;
			return true;
		} else
			return false;
	...
	public static boolean right() {
		if (InputOne.key() == 32 | InputOne.key() == 22 | InputTwo.key() == 32 | InputTwo.key() == 22) {
			RTL = false;
			return true;
		} else
			return false;
	...
	public static boolean up() {
		if (InputOne.key() == 51 | InputOne.key() == 19 | InputTwo.key() == 51 | InputTwo.key() == 19)
			return true;
		else
			return false;
	}
	...
	public static boolean down() {
		if (InputOne.key() == 47 | InputOne.key() == 20 | InputTwo.key() == 47 | InputTwo.key() == 20)
			return true;
		else
			return false;
	}
	...
	public TextureRegion getRegionPlayer(String key) {
		return anim.textureRegionsPlayer.get(key);
	}
